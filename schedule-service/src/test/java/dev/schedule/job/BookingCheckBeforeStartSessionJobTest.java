...
public class BookingCheckBeforeStartSessionJobTest {
    ...
    final BookingCheckBeforeStartSessionJob job = new BookingCheckBeforeStartSessionJob(rabbitMQProducer, scheduler);
